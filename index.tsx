/* pages/index.tsx
   Minor polish: Home cards point to specific sections on Services via hash anchors.
*/
...
export default function Home() {
  return (<div>
    ...
    <div className="grid">
      <div className="card"><h3>🔐 Security & Safety</h3><p className="small">Live monitoring + AI analytics.</p><Link href="/services#security">Open →</Link></div>
      <div className="card"><h3>✅ Quality Assurance</h3><p className="small">Oversight that keeps every shift aligned.</p><Link href="/services#qa">Open →</Link></div>
      <div className="card"><h3>🛎️ Remote Lobby Services</h3><p className="small">Visitor, delivery & access management.</p><Link href="/services#lobby">Open →</Link></div>
      <div className="card"><h3>🧩 Process Control</h3><p className="small">Structured observation & smart alerts.</p><Link href="/services#process">Open →</Link></div>
      <div className="card"><h3>🧭 SafeAway</h3><p className="small">Short-term monitoring while you’re away.</p><Link href="/services#safeaway">Open →</Link></div>
